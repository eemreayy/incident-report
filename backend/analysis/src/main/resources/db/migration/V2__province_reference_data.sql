-- The 81 provinces of Turkey, keyed by licence plate code.
--
-- Reference data lives in its own migration so it can change without touching the schema. The
-- province extractor (T-12) reads this list, so it is the single source of truth for both
