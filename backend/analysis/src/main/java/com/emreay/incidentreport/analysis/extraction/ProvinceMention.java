 ...
 *
 * @param name  the province's canonical name, spelled as the reference data spells it, so it can be
 *              looked up without a second round of normalization
 ...
 */
public record ProvinceMention(String name, int start, int end) {
