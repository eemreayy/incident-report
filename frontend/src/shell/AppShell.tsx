...
/**
 * The panel screen, S-1 in PRD 5.4: enter a report, see what came out of it,
 * then the same records as a shape over time, as totals, and one by one.
 *
 * Note what is *not* passed between the filter bar, the chart, the summary and
 * the list: nothing. All four read the address bar (ADR-037), which is what
 * keeps them showing one view without a copy of the filter state per panel.
 *
