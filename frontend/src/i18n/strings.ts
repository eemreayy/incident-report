...
export const strings = {
  ...
  detail: {
    ...
    loading: 'Getiriliyor…',
    retry: 'Tekrar dene',
    incidentHeading: (id: number) => `Olay kaydı #${id}`,
    incidentMissing: 'Bu olay kaydı bulunamadı.',
    occurredOn: 'Tarih',
    scope: 'Kapsam',
    metrics: 'Metrikler',
    ...
    keywordsEmpty: 'Bu kayıt için anahtar kelime saklanmamış.',
    sourceReport: 'Kaynak bildirim',
    openSourceReport: 'Ham metni aç',
    reportHeading: 'Ham bildirim',
    reportMissing: 'Bu ham bildirim bulunamadı.',
    submittedAt: 'Gönderim zamanı',
    rawText: 'Ham metin (değiştirilmemiş)',
    highlightNote:
      'Vurgulanan kelimeler analizde hangi çıkarımı tetiklediğiyle birlikte işaretlenmiştir; metnin kendisi hiç değiştirilmez.',
    derived: 'Bu bildirimden türeyen kayıtlar',
    derivedEmpty: 'Bu bildirimden yapılandırılmış kayıt üretilmemiş.',
    derivedCount: (count: number) => `${count} kayıt`,
    analysisStatus: 'Analiz durumu',
    analysisAnalyzed: 'tamamlandı',
    analysisFailed: 'başarısız',
    analysisMissing: 'analiz kaydı yok',
    analyzedAt: 'Analiz zamanı',
    openIncident: 'Kaydı aç',
    reprocess: 'Yeniden işle',
    reprocessing: 'Yeniden işleniyor…',
    // FR-15: the text is never touched; only what was derived from it is
    // replaced, so nothing doubles.
    reprocessNote:
      'Güncel kurallarla yeniden analiz eder. Ham metin değişmez; önceki kayıtların yerini yeni sonuç alır, mükerrer kayıt oluşmaz.',
    reprocessDone: 'Yeniden işlendi; aşağıdaki kayıtlar güncel sonuçtur.',
  },
  chart: {
